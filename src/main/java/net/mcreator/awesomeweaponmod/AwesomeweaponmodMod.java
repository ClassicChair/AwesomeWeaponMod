package net.mcreator.awesomeweaponmod;
...
@Mod("awesomeweaponmod")
public class AwesomeweaponmodMod {
	public static final Logger LOGGER = LogManager.getLogger(AwesomeweaponmodMod.class);
	public static final String MODID = "awesomeweaponmod";

	public AwesomeweaponmodMod() {
